...
<div class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
    ...
    <div class="text-center mb-6">
        ...
        <p class="text-xs text-gray-500 mt-1">Sign in with your administrative credentials</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.login') }}" class="space-y-4">
        ...
        <div>
            ...
            <input id="email" type="email" name="email" value="{{ old('email', 'admin@yopmail.com') }}" required autofocus
    ...
    <div class="mt-6 pt-4 border-t border-gray-100 text-center">
        <p class="text-xs text-gray-500">
            Normal user? <a href="{{ route('login') }}" class="text-blue-600 hover:underline">User Login</a>
        </p>
    </div>
</div>
@endsection
